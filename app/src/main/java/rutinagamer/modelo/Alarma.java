...
public class Alarma {
     ...
     * desafio (nuevos numeros, por ejemplo) y limpia el estado de
    ...
    /**
     * Intenta apagar la alarma con la entrada del usuario. Delega toda
     * la evaluacion en el Desafio: Alarma no sabe ni le importa si es
     * una cuenta matematica o un conteo de movimientos.
     */
